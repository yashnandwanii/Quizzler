    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border.all(
              color: const Color.fromARGB(255, 33, 54, 243), width: 1.5),
        ...
        Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                podiumColors[rank - 1].withOpacity(0.9),
                podiumColors[rank - 1].withOpacity(0.4),
              ],
            ),
    ...
    return Expanded(
      child: Container(
        decoration: BoxDecoration(
          color: Colors.white,
          border: Border.all(
              color: Colors.grey.shade200, width: 1, style: BorderStyle.solid),
