...
class _EnhancedQuestionCardState extends State<EnhancedQuestionCard> {
  ...
  Widget _buildOptionsSection(List<String> options, String userAnswer, String correctAnswer) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
  ...
  Widget _buildAnswerSummary(String userAnswer, String correctAnswer, bool isCorrect) {
    return Container(
