  ...
  Future<void> initializeQuiz() async {
    try {
      ...
      if (widget.category.apiCategory.isNotEmpty) {
        ...
        quizData = await EnhancedQuizApiService.fetchRandomQuizzesWithPreferences(
          preferences: widget.preferences,
        );
      }
      ...
      if (quizData.isEmpty) {
        setState(() {
          hasError = true;
          errorMessage = 'No questions found for the selected criteria. Try adjusting your preferences.';
          isLoading = false;
        });
        return;
      }
      ...
      setState(() {
        hasError = true;
        errorMessage = 'Failed to load quiz questions. Please check your internet connection and try again.';
        isLoading = false;
      });
